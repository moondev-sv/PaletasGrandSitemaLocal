            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <center>
                            <input id="pagar" style="margin: 5px;" placeholder="Ingrese el pago recibido" type="number" step="0.01" min=0.01 class="form-control form-control" onkeypress="validarPago(event);" onkeyup="calcularVuelto();" required>

                            <div class="alert alert-info" role="alert" id="vueltoAlert">
