...
if (count($productos) > 0) {
	...
	{
		imprimirPantalla($productosFormateados, $fecha, $MaxTicketN, $total, $fechaFin, $cantAnulados, $totalAnulados, $totaTarlCredito, $totalEfectivo);
	}
	else
	{
		imprimir($productosFormateados, $fecha, $MaxTicketN, $total, $fechaFin, $cantAnulados, $totalAnulados, $totaTarlCredito, $totalEfectivo);
		$connection = new BaseDatos();
...
function imprimirPantalla($productosFormateados, $fecha, $numeroTicket, $total, $fechaFin, $cantAnulados, $totalAnulados, $totaTarlCredito, $totalEfectivo)
{
	...
	print("X funciones libres<br>");

	print("Efectivo N°    $ $total<br>");

	print("----------------------------------<br>");

	print("X productos<br>");

	//print_r($productosFormateados);
...
function imprimir($productosFormateados, $fecha, $numeroTicket, $total, $fechaFin, $cantAnulados, $totalAnulados, $totaTarlCredito, $totalEfectivo)
{
