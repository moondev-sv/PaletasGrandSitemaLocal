...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-07-2019 a las 15:32:22
...
ALTER TABLE `producto`
  ADD CONSTRAINT `fk_producto_categoria` FOREIGN KEY (`cat_producto`) REFERENCES `categoria` (`idcategoria`) ON UPDATE CASCADE;
